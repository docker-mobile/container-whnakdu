...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-whnakdu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-whnakdu.containers.anotherwebservice.com/
...
```
git clone git@github.com:docker-mobile/container-whnakdu.git
cd container-whnakdu
```
...
```
docker attach container-whnakdu
```
